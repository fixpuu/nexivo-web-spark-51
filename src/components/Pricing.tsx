...
const Pricing = () => {
  ...
  return (
    <section id="prezzi" className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl shadow-xl hover-lift animate-scale-in ring-2 ring-primary/20 nexivo-shadow">
            <div className="bg-blue-600 text-white text-xs sm:text-sm font-semibold px-3 sm:px-4 py-1.5 sm:py-2 rounded-full inline-block mb-3 sm:mb-4">
              ✨ SERVIZIO PREMIUM
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 p-3 sm:p-4 rounded-lg mb-4 sm:mb-6">
              <h4 className="font-medium text-blue-800 text-sm sm:text-base mb-1 sm:mb-2">📝 Nota sui domini:</h4>
        ...
        <div className="mt-8 sm:mt-12 max-w-2xl mx-auto">
          <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl shadow-lg animate-fade-in-delayed">
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Servizi aggiuntivi disponibili:</h3>
            <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {extras.map((extra, index) => (
                <li key={index} className="flex items-center gap-2 sm:gap-3">
                  <Check className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
                  <span className="text-gray-700 text-sm sm:text-base">{extra}</span>
                </li>
              ))}
            </ul>
